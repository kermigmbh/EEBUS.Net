...
namespace TestProject1.Bugs
{
    ...
    public class SubscriptionAndBindingMessagesNotProcessed : EebusTests
    {
        ...
        const string BindingRequestCall = """{"data":[{"header":[{"protocolId":"ee1.0"}]},{"payload":{"datagram":[{"header":[{"specificationVersion":"1.3.0"},{"addressSource":[{"device":"i:51593_u:GTHE0300000086-CLS2"},{"entity":[2]},{"feature":1}]},{"addressDestination":[{"device":"EEBUS_162410145_21821"},{"entity":[0]},{"feature":0}]},{"msgCounter":13470},{"cmdClassifier":"call"},{"ackRequest":true}]},{"payload":[{"cmd":[[{"nodeManagementBindingRequestCall":[{"bindingRequest":[{"clientAddress":[{"device":"i:51593_u:GTHE0300000086-CLS2"},{"entity":[2]},{"feature":1}]},{"serverAddress":[{"device":"EEBUS_162410145_21821"},{"entity":[1]},{"feature":2}]},{"serverFeatureType":"LoadControl"}]}]}]]}]}]}}]}""";
        ...
        [Fact]
        public async Task WasWaitingForData_On_SubscriptionRequest()
        {
        ...
        [Fact]
        public async Task WasWaitingForData_OnBindingRequest()
        {
            Connection connection = GetDefaultMockConnection();
